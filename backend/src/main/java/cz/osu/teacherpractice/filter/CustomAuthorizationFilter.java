...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (request.getServletPath().equals("/favicon.ico") || request.getServletPath().equals("/healthCheck/ping") || request.getServletPath().equals("/login") || request.getServletPath().equals("/register") || request.getServletPath().equals("/register/confirm") || request.getServletPath().equals("/register/schools") || request.getServletPath().equals("/forgotPassword/reset") || request.getServletPath().equals("/forgotPassword/save")) {
